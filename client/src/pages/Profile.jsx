      ...
      rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
          ...
          <label htmlFor="avatar" className='flex items-center gap-3 cursor-pointer'>
            ...
            <img src={selectedImg ? URL.createObjectURL(selectedImg): avatar_icon}
        ...
        <img className={`max-w-44 aspect-square rounded-full mx-10 max-sm:mt-10 ${selectedImg&&'rounded-full'}`} src={authUser?.profilePic || logo_icon} alt=""></img>
      </div>
    </div>
  )
}
